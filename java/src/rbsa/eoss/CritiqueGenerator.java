...
public class CritiqueGenerator extends GenericTask {
    ...
    public List<String> getCritique() {
        ...
        try {
            ...
            Vector<String> list1 = (Vector<String>) r.getGlobalContext().getVariable("*p*").externalAddressValue(null);
            ...
            Vector<String> list2 = (Vector<String>) r.getGlobalContext().getVariable("*q*").externalAddressValue(null);
